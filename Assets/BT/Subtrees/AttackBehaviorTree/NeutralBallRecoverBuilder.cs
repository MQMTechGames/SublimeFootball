...
[System.Serializable]
public class NeutralBallRecoverBuilder : MonoBehaviour, IBehaviorWithTree, IBehaviorTreeBuilder
{
    BehaviorTree _bt;
...
//            waitWhileBallIsComingTillIsClose.AddChild(keepWaittingTillBallIsClose);
        ...
        _bt = new BehaviorTree(BehaviortreeNames.NeutralBallRecover);

        _bt.Init(recoverTheBall);
